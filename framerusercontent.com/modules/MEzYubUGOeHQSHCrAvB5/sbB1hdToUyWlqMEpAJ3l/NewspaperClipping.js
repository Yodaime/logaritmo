...
var NewspaperClipping_default = (React) => {
    if (!Component) {
        ...
        const NewspaperClipping = React.forwardRef((props, ref) => /* @__PURE__ */ React.createElement("g", {
            ref,
            ...props
